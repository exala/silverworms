...
export function CheckEmailResend({ email, role, initialSeconds = 60 }: { email: string; role: string; initialSeconds?: number }) {
  ...
  return (
    <form action={resendMagicLinkAction} className="mt-4 flex flex-wrap items-center gap-3">
